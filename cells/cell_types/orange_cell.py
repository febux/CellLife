...
from cells.genome.orange_cell__genome import OrangeCellGenome
from constants import Color


class OrangeCell(Cell):
    energy_value = 10
    genome = OrangeCellGenome

    def __init__(self, x: int, y: int, color: Color = Color.ORANGE) -> None:
